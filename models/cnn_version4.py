...
class Network(nn.Module):
    def __init__(self, image_shape, dropout_probs):
        ...
        self.fc1 = FCBlock(256, 512, dropout_probs[8]).to(self.device)
        self.fc2 = FCBlock(512, 256, dropout_probs[9]).to(self.device)
        self.steer_output = nn.Linear(256, 1).to(self.device)
...
def train(model, train_dataloader, val_dataloader, steer_criterion, optimizer, scheduler, num_epochs):
    ...
    print("\nTraining completed!")
    print("Final model saved as 'model4.pth'")
